...
interface ServerInterface {
    ...
    fun getMovieDetail (@Header ("x-api-key") key : String, @Body detailRequest : DetailRequest) : Call<ArrayList<MovieDetail>>
    ...
    @POST ("/Development/movies/search/recommend")
    fun getRecommend (@Header ("x-api-key") key : String, @Body detailRequest : DetailRequest) :Call<RecommendResponse>
}